...
delta_x = upperboundx - lowerboundx;
delta_y = upperboundy - lowerboundy;
log_count = log(count);
log_delta_x = log(delta_x / ncellx);
log_delta_y = log(delta_y / ncelly);
estimate = estimate + log_count + log_delta_x + log_delta_y;
