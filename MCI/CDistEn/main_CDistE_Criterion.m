...
%% computing cross-distribution entropy, saving, extracting and loading
batch_Save_CDistE;
batch_Extract_CDistE;
load MCI_NC_CDistE


%% a svm classifier with matlab cross validation and no Monte-Carlo

% CVSVMModel = fitcsvm(XP,YP,'Standardize',true,...
%     'ClassNames',{'MCI','NC'},'CrossVal','on');
