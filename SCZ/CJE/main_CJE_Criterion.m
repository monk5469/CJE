% This file adop a CJE to classify a SCZ and a NC group 
% in 5-fold cross validation. 

clear all;
close all;

%% computing CJE, saving, extracting and loading
% Here SCZ_NC_CJE_Brain stands for Sub_N+CJE, 
% SCZ_NC_CJE_BMax stands for Sub_NM+CJE, 
% SCZ_NC_CJE_Max stands for ROI_NM+CJE, 
% SCZ_NC_CJE_ROI stands for ROI_N and No stands for No_N+CJE. 

batch_Save_CJE;
batch_Extract_CJE;
load SCZ_NC_CJE_Brain.mat
