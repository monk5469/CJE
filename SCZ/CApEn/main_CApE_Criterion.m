% This file adop a CApE to classify a SCZ and a NC group 
% in 5-fold cross validation. 

clear all;
close all;

%% computing CApE, saving, extracting and loading
% Here SCZ_NC_CApE_Brain stands for Sub_N+CApE, 
% SCZ_NC_CApE_BMax stands for Sub_NM+CApE, 
% SCZ_NC_CApE_Max stands for ROI_NM+CApE, 
% SCZ_NC_CApE_ROI stands for ROI_N and No stands for No_N+CApE. 

batch_Save_CApE;
batch_Extract_CApE;
load SCZ_NC_CApE_Brain
...
%%% For corss validation  %%%%%%
  ...
  SVMModel = ClassificationKNN(Data_train,Label_train,'KernelScale','auto','Standardize',true,...
