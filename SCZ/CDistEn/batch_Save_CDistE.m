% This function mainly calculates the CDistEn of the subject and saves it.
% CDistEn calculates the cross-distribution entropy.
...
for g  = 1 : length(Group)
   ...
   for nSub = 1 : Num(g)
    ...
    if strcmp(Group(g),'SCZ')
       ...
       RHO = CDistE(ROI_tmp);
       t(nSub,:)=toc;
       save([ 'CDistE_data\SCZ_CDistE_', num2str(nSub), '.mat'],'RHO');
