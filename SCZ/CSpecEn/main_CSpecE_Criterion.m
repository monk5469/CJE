% This file adop a CSpecEn to classify a SCZ and a NC group 
% in 5-fold cross validation. 

clear all;
close all;

%% computing cross-spectral entropy, saving, extracting and loading
batch_Save_CSpecE;
batch_Extract_CSpecE;
load SCZ_NC_CSpecE_Brain
