% This function mainly calculates the CSpecEn of the subject and saves it.
% CSpecEEn calculates the cross-spectral entropy.
...
%        tic
       RHO = CSpecE(ROI_tmp);
%        t(nSub,:)=toc;
       save([ 'CSpecE_data\SCZ_CSpecE_', num2str(nSub), '.mat'],'RHO');
